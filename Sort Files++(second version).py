...
class Window(customtkinter.CTk):
    def __init__(self):
        ...
        ExitMenu = Menu(MenuBar,tearoff = 0,font=5, activebackground="black", activeforeground="red", fg="Blue",
                        bg="white")
        
        ExitMenu.add_command(label = "Exit",command=  self.go)

        HelpMenu = Menu(MenuBar,tearoff = 0,font=5, activebackground="black", activeforeground="red", fg="Blue",
                        bg="white")
...
class Start(customtkinter.CTk):
    def __init__(self):
        ...
        ExitMenu = Menu(MenuBar,tearoff = 0,
                        font=5, activebackground="black", activeforeground="red", fg="Blue",
                        bg="white")
        ...
        self.main_frame = customtkinter.CTkFrame(self,fg_color="#ffffff")
        self.main_frame.pack(fill= "both" , expand = True)

        self.welcome = customtkinter.CTkLabel(self.main_frame,text_color="black",text = "Welcome",font=customtkinter.CTkFont(size=25),fg_color="transparent")
        self.welcome.pack(pady= 15)

        self.logo = customtkinter.CTkLabel(self.main_frame,text="",fg_color="transparent",image = customtkinter.CTkImage(Image.open("logo.ico"),size=(200,200)),height=200,width=200)
        self.logo.pack(pady = 15)

        self.start_btn = customtkinter.CTkButton(self.main_frame,text="Start",text_color="white",hover_color="#0000FF",fg_color="DarkBlue",width=150,height=50,command = self.start)
